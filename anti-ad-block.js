function showAdBlockOverlay() {
  ...
  adBlockOverlay.innerHTML = `
    <div class="bg-white dark:bg-dark rounded-2xl p-8 shadow-2xl max-w-sm sm:max-w-md w-full animate-fade-in border-4 border-transparent bg-gradient-to-r from-red-500 via-yellow-500 to-red-500">
